<template>
  <div v-click-outside="() => (dropdownOpened = false)">
      <button
          type="button"
          class="relative py-2 pr-10 pl-3 w-full text-left bg-cod-gray-800/50 text-slate-400 rounded-md border border-slate-700 cursor-pointer focus:outline-none focus:ring-1 focus:border-sky-500 sm:text-sm"
      ...
      >
        <ul
            v-if="dropdownOpened"
            class="overflow-auto absolute z-10 py-1 mt-1 w-full max-h-60 text-base bg-cod-gray-800 rounded-md ring-1 ring-black ring-opacity-5 shadow-lg focus:outline-none sm:text-sm"
