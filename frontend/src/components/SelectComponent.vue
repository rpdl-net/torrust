<template>
  <div v-click-outside="() => (dropdownOpened = false)">
      <button
          type="button"
          class="relative py-2 pr-10 pl-3 w-full text-left bg-cod-gray-900/50 text-slate-400 rounded-md border border-slate-700 cursor-pointer focus:outline-none focus:ring-1 focus:border-sky-500 sm:text-sm"
