<template>
  <div class="text-sm leading-6 mt-12">
    <div class="pt-10 pb-28 border-t sm:flex justify-end text-slate-600 border-slate-200/5">
...
<!--      </div>-->
      ...
      <a class="ml-2 pl-2 border-l border-slate-600 hover:text-white transition duration-200" href="https://rpdl.net/donate">Donate</a><br>
