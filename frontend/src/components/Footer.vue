<template>
  <div class="text-sm leading-6 mt-12">
    <div class="pt-10 pb-28 border-t sm:flex justify-end text-white border-slate-200/5">
<!--      <div class="mb-6 sm:mb-0 sm:flex">-->
<!--        <a class="hover:text-white" href="">Terms of Service</a>-->
<!--        <p class="sm:ml-4 sm:pl-4 sm:border-l sm:border-slate-200/5"><a class="hover:text-white" href="">Privacy Policy</a></p>-->
<!--      </div>-->
