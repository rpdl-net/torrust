        ...
        <div class="relative flex items-center">
          ...
          <div class="relative flex items-center ml-auto">
            ...
            <div class="ml-4 flex items-center">
              <a href="https://rpdl.net/#/portal/signup" class="px-4 py-1.5 bg-[#ffd700] text-sm text-[#0f172a] border border-[#ffd700] rounded-md transition duration-200 hover:shadow-lg hover:shadow-[#ffdf33]/25">
