        ...
        <div class="relative flex items-center">
          ...
          <div class="relative flex items-center ml-auto">
            ...
            <div class="ml-4 flex items-center">
              <a href="https://rpdl.net/donate/" class="px-4 py-1.5 bg-[#ffd700] text-sm text-white border border-sky-500 rounded-md transition duration-200 hover:shadow-lg hover:[#ffdf33]/25">
