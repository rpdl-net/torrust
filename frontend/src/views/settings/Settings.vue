      ...
      <div id="general-settings">
        ...
        <ul class="py-2">
          <li v-for="(category, index) in categoriesState" :key="index">
            <div class="py-2 px-4 mt-2 bg-cod-gray-800 rounded-md flex flex-row">
...
.tab {
  @apply inline-block py-2 px-4 text-sm font-medium text-center text-sky-500 bg-cod-gray-800 rounded-t-md;
}
