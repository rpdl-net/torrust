      ...
      <div id="general-settings">
        ...
        <ul class="py-2">
          <li v-for="(category, index) in categoriesState" :key="index">
            <div class="py-2 px-4 mt-2 bg-cod-gray-900 rounded-md flex flex-row">
...
.tab {
  @apply inline-block py-2 px-4 text-sm font-medium text-center text-sky-500 bg-cod-gray-900 rounded-t-md;
}

input {
  @apply py-2 px-4 w-full text-white bg-cod-gray-900 border border-slate-700 rounded-md text-sm shadow-sm cursor-pointer placeholder-slate-400 hover:border-sky-500 focus:bg-neutral-800
