...
<!--          </button>-->
    ...
    <h1 v-else-if="!loading" class="py-6 text-slate-600 italic">Torrent not found.<br>Try search for new version or ask on <a href="https://rpdl.net/discord">Discord</a>!</h1>
