...
<!--        </div>-->
        <div class="w-full overflow-hidden">
          ...
          <div class="py-4 flex flex-col flex-col-reverse lg:flex-row">
            <div class="px-1 py-1 w-full lg:w-2/3 flex flex-col lg:flex-row flex-row bg-cod-gray-800/50 rounded-md">
...
<!--        <div class="px-3 py-2 text-2xl text-white bg-cod-gray-800 rounded-md"></div>-->
      </div>
      <div>
<!--        <div class="py-3 border-b border-slate-200/5"></div>-->
        ...
        <MarkdownItVue v-if="editingDescription" :content="newDescription" class="px-4 py-4 max-h-64 overflow-auto md-body max-w-none prose-sm prose-blue bg-cod-gray-800/50 rounded-md" />
...
<style>
.status {
  @apply px-2 py-1.5 w-1/2 flex flex-row bg-cod-gray-800/50 text-slate-200 capitalize border border-transparent rounded-md text-sm uppercase;
}
...
textarea.input {
  @apply py-2 px-4 bg-cod-gray-800/50 appearance-none w-full text-slate-200 rounded-md leading-tight focus:outline-none;
}
